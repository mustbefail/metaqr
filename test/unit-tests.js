...
const { QrMatrix } = require('../src/matrix/QrMatrix');
const { setupPatterns } = require('../src/matrix/patterns');
const { fillData } = require('../src/matrix/data');
const { applyMask } = require('../src/matrix/mask');
const { encode } = require('../src/qrEncoder');
const { ECC_LEVELS, MODES, getDataCapacity, getCharCountSize } = require('../src/spec');
