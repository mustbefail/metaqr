 ...
 * @param {number} pattern Mask pattern index.
 */
 ...
 * @param {QrMatrix} matrix
 * @param {Function} applyFormatFn Function to apply format info
 * (e.g. ECC level) to the matrix.
 * @param {EccLevel} eccLevel ECC level.
 */
